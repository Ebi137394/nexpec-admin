...
export default function CreateJobScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ Ensure required_certifications is always an array of strings for text[] column
      const certificationsArray = Array.isArray(formData.required_certifications)
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          required_certifications: certificationsArray, // ✅ Array of strings for text[] column
          status: 'open',
      ...
      Alert.alert(
        ...
        [
          {
            text: 'View Job',
            onPress: () => router.replace(`/client/jobs/${data.id}`),
          },
          {
