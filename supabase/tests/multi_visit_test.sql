...
BEGIN
  ...
  VALUES (gen_random_uuid(), v_client, v_lead, 'LEGACY VISIT JOB', 'suite',
          'in_progress','approved', v_when)
  RETURNING id INTO v_legacy;

  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status, scheduled_date)
  VALUES (gen_random_uuid(), v_client, v_lead, 'MULTI VISIT JOB', 'suite',
          'in_progress','approved', v_when)
  RETURNING id INTO v_job;

  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status)
  VALUES (gen_random_uuid(), v_client2, v_rando, 'OTHER CLIENT JOB', 'suite',
