// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/live-radar.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminLiveRadarRedirect() {
  return <Redirect href="/(admin)/live-radar" />;
}
