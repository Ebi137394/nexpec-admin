// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/job-moderation.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminJobModerationRedirect() {
  return <Redirect href="/(admin)/job-moderation" />;
}
