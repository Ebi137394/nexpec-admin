// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/admin-contracts.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminContractsRedirect() {
  return <Redirect href="/(admin)/admin-contracts" />;
}
