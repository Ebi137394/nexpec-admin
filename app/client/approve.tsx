// ════════════════════════════════════════════════════════════════════════════
//  app/client/approve.tsx — LANE-A-PHASE-2.6 route-consolidation stub
//
...
export default function LiteralClientApproveRedirect() {
  return <Redirect href="/(client)/approve" />;
}
