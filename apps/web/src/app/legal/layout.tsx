// ════════════════════════════════════════════════════════════════════════════
//  app/legal/layout.tsx — shared chrome for legal pages
//
//  Lightweight wrapper mirroring the /contact route: same dark canvas
//  + topo grid backdrop, slim header with Logo + back link, page
//  content rendered as readable prose width. Reused by /legal/terms,
//  /legal/privacy, /legal/compliance-notices.
// ════════════════════════════════════════════════════════════════════════════
