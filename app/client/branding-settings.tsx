// ════════════════════════════════════════════════════════════════════════════
//  app/client/branding-settings.tsx — LANE-A-PHASE-2.6 route-consolidation stub
//
...
export default function LiteralClientBrandingRedirect() {
  return <Redirect href="/(client)/branding-settings" />;
}
