// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/audit-trail.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminAuditTrailRedirect() {
  return <Redirect href="/(admin)/audit-trail" />;
}
