// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/financial/pending-payouts.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminFinPendingPayoutsRedirect() {
  return <Redirect href="/(admin)/financial/pending-payouts" />;
}
