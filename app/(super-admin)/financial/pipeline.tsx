// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/financial/pipeline.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminFinPipelineRedirect() {
  return <Redirect href="/(admin)/financial/pipeline" />;
}
