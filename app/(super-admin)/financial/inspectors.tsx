// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/financial/inspectors.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminFinInspectorsRedirect() {
  return <Redirect href="/(admin)/financial/inspectors" />;
}
