...
export default function JobDetailScreen() {
  ...
  const handleHire = async (proposal: Proposal) => {
    Alert.alert(
      'Hire Inspector',
      `Are you sure you want to hire ${proposal.applicant.full_name} for $${proposal.bid_amount}?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert(
                'Success',
                `You have hired ${proposal.applicant.full_name}! A contract draft has been created.`,
