// ════════════════════════════════════════════════════════════════════════════
//  src/components/client/finance/index.ts — LANE-B-PHASE-5.1 re-export stub
//
//  Pre-strike: canonical location. Post-strike: relocated to @/src/roles/client/components/finance/index;
