// ============================================================
// OperationsDashboardMinimal – Minimal version for debugging
// Only includes essential components to isolate the hooks issue
// ============================================================
...
import { MOCK_BATCH_PROJECTS } from './actions/BatchActionBar';

export default function OperationsDashboardMinimal() {
  ...
  // ── Selection State (moved to top to fix hooks error) ───────────────────────────────────────────
  const [selectedIds, setSelectedIds] = useState<string[]>([]);
  const [selectionMode, setSelectionMode] = useState(false);

  // ── Selection Handlers (moved to top to fix hooks error) ─────────────────────────────────────────
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.testContainer}>
          <Text style={styles.testTitle}>Minimal Operations Dashboard</Text>
          <Text style={styles.testSubtitle}>Debugging hooks issue</Text>
