// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/communications/index.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminCommsRedirect() {
  return <Redirect href="/(admin)/communications" />;
}
