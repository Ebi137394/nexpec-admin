// ════════════════════════════════════════════════════════════════════════════
//  hooks/useInspectorData.ts — LANE-A-PHASE-3 re-export stub
//
//  Pre-strike: canonical location. Post-strike: relocated to @/src/roles/inspector/hooks/useInspectorData;
