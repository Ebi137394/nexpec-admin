// ════════════════════════════════════════════════════════════════════════════
//  app/client/messages/page.tsx — Help & Support + job-scoped rooms for
//  client / agency / enterprise viewers.
// ════════════════════════════════════════════════════════════════════════════
...
export default async function ClientMessagesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <RoomList
        rooms={rooms}
        linkBase="/client/messages"
        emptyTitle="No conversations yet"
        emptyBody="Click Open Help & Support to start a chat with admin, or message admin from any job page."
      />

      <p className="text-[11px] text-zinc-600">
        <Link href="/client/jobs" className="underline hover:text-zinc-400">
          See your jobs
        </Link>{' '}
        to open a job-scoped chat with admin.
      </p>
    </div>
  );
}
