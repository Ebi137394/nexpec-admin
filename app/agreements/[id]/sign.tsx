// app/agreements/[id]/sign.tsx — generic Review & sign for a counterparty's own leg
//   (supplier_supply / inspector_engagement / client_supply). RLS scopes the row to
//   the signed-in counterparty, so suppliers and inspectors sign their own agreement.
