// ════════════════════════════════════════════════════════════════════════════
//  app/client/contracts/page.tsx — list my assignments + sign flow
// ════════════════════════════════════════════════════════════════════════════
      ...
      {unsignedRequired.length > 0 && (
        <div className="flex items-start gap-3 rounded-2xl border border-accent-amber/30 bg-accent-amber/10 p-4">
          ...
          <p className="text-sm text-accent-amber">
            ...
            {unsignedRequired.length === 1 ? '' : 's'} waiting for your
            signature. Some features may be restricted until signed.
          </p>
        </div>
      )}
            ...
            return (
              ...
              >
                <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  {/* Open canonical PDF / external link */}
                  {c?.pdfUrl && (
                    <a
                      href={c.pdfUrl}
                      target="_blank"
                ...
                {!signed && (
                  ...
                  >
                    ...
                    <p className="mt-2 text-[11px] text-zinc-500">
                      ...
                      Equivalent to a typed e-signature; admin counter-signs separately.
                    </p>
                  </form>
                )}
              </li>
