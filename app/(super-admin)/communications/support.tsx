// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/communications/support.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminCommsSupportRedirect() {
  return <Redirect href="/(admin)/communications/support" />;
}
