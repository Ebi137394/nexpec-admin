    ...
    <Modal visible={open} transparent animationType="fade" onRequestClose={onClose}>
      <View style={vp.overlay}>
        <View style={vp.card}>
          ...
          <TouchableOpacity onPress={onClose} hitSlop={10} style={vp.close}><Ionicons name="close" size={20} color={T.colors.textMuted} /></TouchableOpacity>
          <ScrollView contentContainerStyle={{ padding: 24 }} showsVerticalScrollIndicator={false}>
            ...
            {requested ? (
              <View style={vp.okBox}>
                <Text style={vp.okTitle}>Request received</Text>
                <Text style={vp.okBody}>NEXPEC will arrange your VIP upgrade and confirm the named-disclosure terms.</Text>
              </View>
            ) : (
              <>
                ...
                <TouchableOpacity onPress={() => { onRequest?.(); setRequested(true); }} style={vp.cta} activeOpacity={0.85}>
                  <Text style={vp.ctaTxt}>Request Named Disclosure</Text>
