// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/reviews-moderation.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminReviewsModerationRedirect() {
  return <Redirect href="/(admin)/reviews-moderation" />;
}
