// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/financial/active-jobs.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminFinActiveJobsRedirect() {
  return <Redirect href="/(admin)/financial/active-jobs" />;
}
