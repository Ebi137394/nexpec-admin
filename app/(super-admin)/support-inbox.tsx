// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/support-inbox.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminSupportInboxRedirect() {
  return <Redirect href="/(admin)/support-inbox" />;
}
