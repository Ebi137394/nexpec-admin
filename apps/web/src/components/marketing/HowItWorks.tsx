...
const STEPS: readonly Step[] = [
  {
    ...
    body: 'Describe the asset and the standard — API, ASME, ACI, NETA, OSHA PSM, AWS — and the deadline. Our spec assistant suggests requirements from similar jobs in your discipline.',
  ...
  },
  {
    ...
    body: 'Vetted inspectors apply, ranked by discipline and proximity. You pick. Escrow funds the moment both parties sign.',
  ...
  },
  {
    ...
    body: 'Photos, findings and signatures land in a cryptographically-sealed report — every defect bound to the model that found it and anchored beyond dispute. Approve to release escrow.',
