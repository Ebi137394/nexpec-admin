...
const STEPS: readonly Step[] = [
  {
    ...
    body: 'Describe the asset, the standard (API 510, ASME, CCI, NDT), and the deadline. Our spec assistant suggests requirements based on similar jobs.',
  ...
  },
  {
    ...
    body: 'Vetted inspectors apply. Geo-matching surfaces local talent first. You pick. Escrow funds when both parties sign.',
  ...
  },
  {
    ...
    body: 'Photos, findings, and signatures land in a cryptographically-sealed report. Approve to release escrow; revise once if needed.',
