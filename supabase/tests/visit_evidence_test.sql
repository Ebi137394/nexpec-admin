...
BEGIN
  ...
  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status, scheduled_date)
  VALUES (gen_random_uuid(), v_client, v_lead, 'VE LEGACY JOB', 'suite',
          'in_progress','approved', v_when)
  RETURNING id INTO v_legacy;

  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status, scheduled_date)
  VALUES (gen_random_uuid(), v_client, v_lead, 'VE MULTI VISIT JOB', 'suite',
          'in_progress','approved', v_when)
  RETURNING id INTO v_job;

  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status)
  VALUES (gen_random_uuid(), v_client2, v_rando, 'VE OTHER CLIENT JOB', 'suite',
          'in_progress','approved')
  RETURNING id INTO v_otherjob;

  INSERT INTO public.jobs (id, client_id, contractor_id, title, description,
                           status, moderation_status, scheduled_date)
  VALUES (gen_random_uuid(), v_client, v_lead, 'VE SEAL JOB', 'suite',
          'in_progress','approved', v_when)
