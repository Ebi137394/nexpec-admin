// ════════════════════════════════════════════════════════════════════════════
//  hooks/useCriticalAlerts.ts — LANE-A-PHASE-3 re-export stub
//
//  Pre-strike: canonical location. Post-strike: relocated to @/src/core/notifications/hooks/useCriticalAlerts;
