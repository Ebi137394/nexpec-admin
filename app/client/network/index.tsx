// ════════════════════════════════════════════════════════════════════════════
//  app/client/network/index.tsx — LANE-A-PHASE-2.6 route-consolidation stub
//
...
export default function LiteralClientNetworkRedirect() {
  return <Redirect href="/(client)/network" />;
}
