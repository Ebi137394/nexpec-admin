// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/payouts.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminPayoutsRedirect() {
  return <Redirect href="/(admin)/payouts" />;
}
