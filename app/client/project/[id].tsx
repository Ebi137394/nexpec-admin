// ════════════════════════════════════════════════════════════════════════════
//  app/client/project/[id].tsx — LANE-A-PHASE-2.6 route-consolidation stub
//
...
export default function LiteralClientProjectIdRedirect() {
  const { id } = useLocalSearchParams<{ id: string }>();
  if (!id) return <Redirect href={'/(tabs)/client-dashboard' as any} />;
  return <Redirect href={`/(client)/project/${id}` as any} />;
}
