// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/verification/index.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminVerificationRedirect() {
  return <Redirect href="/(admin)/verification" />;
}
