// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/pending-assignments.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminPendingAssignmentsRedirect() {
  return <Redirect href="/(admin)/pending-assignments" />;
}
