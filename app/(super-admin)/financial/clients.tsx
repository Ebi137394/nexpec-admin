// ════════════════════════════════════════════════════════════════════════════
//  app/(super-admin)/financial/clients.tsx — LANE-A-PHASE-2.7 (super-admin)→(admin) rename stub
//
...
export default function SuperAdminFinClientsRedirect() {
  return <Redirect href="/(admin)/financial/clients" />;
}
